...
export default function App() {
  ...
  const [active,  setActive]  = useState(null)   // index affiché
  ...
  async function handleQuery(question, withVisual) {
    ...
    try {
      ...
      setError(err.response?.data?.detail || 'Erreur inattendue — vérifiez que le serveur est actif.')
    } finally {
      setLoading(false)
    }
  }
...
const S = {
  ...
  body: {
    ...
    padding: '28px 32px', maxWidth: 900,
